...
public enum SolarTermColors
{
    ...
    GREATER_HEAT(ColorHelper.simplyMixColor(0x7fb80e, 0.6F, 0xd1923f, 0.4F), 0.9F, 0xffe600, 0.3F),

    // Autumn Solar Terms
    BEGINNING_OF_AUTUMN(ColorHelper.simplyMixColor(0x7fb80e, 0.35F, 0xd1923f, 0.65F), 0.9F, 0xffe600, 0.6F),
    END_OF_HEAT(0xd1923f, 0.7F, 0xffe600, 0.9F),
    WHITE_DEW(0xd1923f, 0.85F, 0xffe600, 1.0F),
    AUTUMNAL_EQUINOX(0xd1923f, 0.8F, 0xffe600, 1.0F),
    COLD_DEW(0xd1923f, 0.75F, 0xffe600, 0.95F),
    FIRST_FROST(0xd1923f, 0.6F, 0xffe600, 0.5F),

    // Winter Solar Terms
    BEGINNING_OF_WINTER(0xd1923f, 0.35F, 0xffe600, 0.3F),
    LIGHT_SNOW(0xd1923f, 0.2F),
    HEAVY_SNOW(0xd1923f, 0.1F),
