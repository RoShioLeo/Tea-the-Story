...
public class StoneMillRecipeBuilder
{
    ...
    private StoneMillRecipeBuilder(Ingredient inputItem, FluidIngredient inputFluid, NonNullList<ItemStack> outputItems, Fluid outputFluid, int workTime)
    {
    ...
    public static StoneMillRecipeBuilder recipe(int workTime, Ingredient inputItem, FluidIngredient inputFluid, Fluid outputFluid, ItemStack... outputItems)
    {
        return new StoneMillRecipeBuilder(inputItem, inputFluid, NonNullList.from(ItemStack.EMPTY, outputItems), outputFluid, workTime);
    }

    public static StoneMillRecipeBuilder recipeWithDefaultTime(Ingredient inputItem, FluidIngredient inputFluid, Fluid outputFluid, ItemStack... outputItems)
    {
    ...
    {
        return recipe(workTime, inputItem, FluidIngredient.EMPTY, Fluids.EMPTY, outputItems);
    }
    ...
    public static class Result implements IFinishedRecipe
    {
        ...
        public Result(ResourceLocation idIn, Ingredient inputItem, FluidIngredient inputFluid, NonNullList<ItemStack> outputItems, Fluid outputFluid, int workTime)
        {
        ...
        public void serialize(JsonObject json)
        {
            ...
            json.addProperty("output_fluid", ForgeRegistries.FLUIDS.getKey(this.outputFluid).toString());
