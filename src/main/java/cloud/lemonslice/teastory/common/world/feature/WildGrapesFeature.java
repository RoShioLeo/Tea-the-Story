...
public class WildGrapesFeature extends Feature<NoFeatureConfig>
{
    public WildGrapesFeature(Codec<NoFeatureConfig> configFactoryIn)
    {
    ...
    {
        BlockState blockstate = BlocksRegistry.WILD_GRAPE.getDefaultState();
        int i = 0;
        for (int j = 0; j < 12; ++j)
        {
