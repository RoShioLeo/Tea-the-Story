...
public final class BlockRegistry extends RegistryModule
{
    ...
    public static final Block BAMBOO_LANTERN = new LanternBlock(Block.Properties.create(Material.BAMBOO).sound(SoundType.BAMBOO).hardnessAndResistance(0.5F).setLightLevel(state -> 15).notSolid())
    {
        @OnlyIn(Dist.CLIENT)
