...
public class BlockLoader
{
    ...
    public static TeaDrinkEmpty wood_cup = new TeaDrinkEmpty(1.0F, "wood_cup", Material.wood, Block.soundTypeWood, 0);
    public static TeaDrinkEmpty stone_cup = new TeaDrinkEmpty(1.3F, "stone_cup", Material.rock, Block.soundTypePiston, 1);
    public static TeaDrinkEmpty glass_cup = new TeaDrinkEmpty(0.8F, "glass_cup", Material.glass, Block.soundTypeGlass, 2);
    public static TeaDrinkEmpty porcelain_cup = new TeaDrinkEmpty(1.5F, "porcelain_cup", Material.rock, Block.soundTypePiston, 3);
    public static TeaDrinkFull burntgreentea_wood_cup = new TeaDrinkFull(1.0F, "burntgreentea_wood_cup", Material.wood, Block.soundTypeWood, 0, 0);
