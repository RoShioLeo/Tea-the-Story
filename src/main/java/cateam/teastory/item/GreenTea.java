...
public class GreenTea extends ItemTeaDrink
{
    ...
    public static void addPotion(int tier, World world, EntityPlayer entityplayer)
    {
    	if (tier <= 1)
    	{
    		entityplayer.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, (int)Math.max(0, ConfigLoader.TeaDrink_Time * (10 + tier * 2) * 0.1F), tier - 1));
    		entityplayer.addPotionEffect(new PotionEffect(PotionLoader.PotionAgility, (int)Math.max(0, ConfigLoader.TeaDrink_Time * (10 + tier * 2) * 0.3F), tier - 1));
    	}
    	else
    	{
    		entityplayer.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, (int)Math.max(0, ConfigLoader.TeaDrink_Time * (12.5F - tier * 2.5F) * 0.1F), tier - 1));
    		entityplayer.addPotionEffect(new PotionEffect(PotionLoader.PotionAgility, (int)Math.max(0, ConfigLoader.TeaDrink_Time * (12.5F - tier * 2.5F) * 0.3F), tier - 1));
    	}
