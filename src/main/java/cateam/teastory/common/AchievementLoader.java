...
//	public static Achievement burntLeaf = new Achievement("achievement.teastory.burntLeaf", "teastory.burntLeaf", 2, 2, ItemLoader.burnt_tea, teaLeaf);
	...
	public static Achievement kettle = new Achievement("achievement.teastory.Kettle", "teastory.Kettle", -4, -2, BlockLoader.empty_porcelain_kettle, null);
//	public static Achievement hotWater = new Achievement("achievement.teastory.hotWater", "teastory.hotWater", -2, -2, ItemLoader.hot_water, kettle);
	...
	public static AchievementPage pageTeaStory = new AchievementPage(TeaStory.NAME, teaSeeds, teaLeaf, teaBasket, teaPlant, halfDriedTea,
			teaDryingPan, teaStove, barrel, greenTea, matchaDrink, blackTea, kettle, wetTea, woodenCup, stoneCup, glassCup, porcelainCup, soilDetectionMeter);
