...
public class RecipeLoader
{
	...
	private static void addTeaTableRecipe()
	{
		...
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.black_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_leaf, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.black_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.green_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.green_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.dried_tea, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.green_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_bag, 8), Collections.singletonList(new ItemStack(Items.MILK_BUCKET)), new ItemStack(BlockLoader.empty_zisha_kettle), new ItemStack(Items.SUGAR, 24), new ItemStack(BlockLoader.milk_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_leaf, 64), Collections.singletonList(new ItemStack(Items.MILK_BUCKET)), new ItemStack(BlockLoader.empty_zisha_kettle), new ItemStack(Items.SUGAR, 24), new ItemStack(BlockLoader.milk_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_bag, 8), OreDictionary.getOres("cropLemon"), new ItemStack(BlockLoader.empty_zisha_kettle), new ItemStack(Items.SUGAR, 24), new ItemStack(BlockLoader.lemon_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.black_tea_leaf, 64), OreDictionary.getOres("cropLemon"), new ItemStack(BlockLoader.empty_zisha_kettle), new ItemStack(Items.SUGAR, 24), new ItemStack(BlockLoader.lemon_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.yellow_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.yellow_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.yellow_tea_leaf, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.yellow_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.white_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.white_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.white_tea_leaf, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.white_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.oolong_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.oolong_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.oolong_tea_leaf, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.oolong_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.puer_tea_bag, 8), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.puer_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.puer_tea_leaf, 64), null, new ItemStack(BlockLoader.empty_zisha_kettle), null, new ItemStack(BlockLoader.puer_tea_zisha_kettle)));
		managerTeaTable.add(new TeaTableRecipe(new ItemStack(ItemLoader.matcha_powder, 64), Collections.singletonList(new ItemStack(ItemLoader.tea_whisk)), new ItemStack(BlockLoader.empty_zisha_kettle), new ItemStack(Items.SUGAR, 24), new ItemStack(BlockLoader.matcha_drink_zisha_kettle)));
	}
}
