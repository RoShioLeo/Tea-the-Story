...
public class RecipeRegister
{
    ...
    private static void addTeaTableRecipe()
    {
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_bag, 4)), OreDictionary.getOres("listAllmilk"), new ItemStack(BlockRegister.empty_porcelain_kettle), sugar12, new ItemStack(BlockRegister.milk_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 32)), OreDictionary.getOres("listAllmilk"), new ItemStack(BlockRegister.empty_porcelain_kettle), sugar12, new ItemStack(BlockRegister.milk_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_bag, 4)), OreDictionary.getOres("cropLemon"), new ItemStack(BlockRegister.empty_porcelain_kettle), sugar12, new ItemStack(BlockRegister.lemon_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 32)), OreDictionary.getOres("cropLemon"), new ItemStack(BlockRegister.empty_porcelain_kettle), sugar12, new ItemStack(BlockRegister.lemon_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.matcha_powder, 32)), tea_whisk, new ItemStack(BlockRegister.empty_porcelain_kettle), sugar12, new ItemStack(BlockRegister.matcha_drink_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_bag, 4)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.black_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.black_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.green_tea_bag, 4)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.green_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.dried_tea, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.green_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.yellow_tea_bag, 4)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.yellow_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.yellow_tea_leaf, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.yellow_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.white_tea_bag, 4)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.white_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.white_tea_leaf, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.white_tea_porcelain_kettle)));
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.oolong_tea_leaf, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.oolong_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.puer_tea_bag, 4)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.puer_tea_porcelain_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.puer_tea_leaf, 32)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_porcelain_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.puer_tea_porcelain_kettle)));


        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_bag, 8)), OreDictionary.getOres("listAllmilk"), new ItemStack(BlockRegister.empty_zisha_kettle), sugar24, new ItemStack(BlockRegister.milk_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 64)), OreDictionary.getOres("listAllmilk"), new ItemStack(BlockRegister.empty_zisha_kettle), sugar24, new ItemStack(BlockRegister.milk_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_bag, 8)), OreDictionary.getOres("cropLemon"), new ItemStack(BlockRegister.empty_zisha_kettle), sugar24, new ItemStack(BlockRegister.lemon_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 64)), OreDictionary.getOres("cropLemon"), new ItemStack(BlockRegister.empty_zisha_kettle), sugar24, new ItemStack(BlockRegister.lemon_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.matcha_powder, 64)), tea_whisk, new ItemStack(BlockRegister.empty_zisha_kettle), sugar24, new ItemStack(BlockRegister.matcha_drink_zisha_kettle)));
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.black_tea_leaf, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.black_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.green_tea_bag, 8)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.green_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.dried_tea, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.green_tea_zisha_kettle)));
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.yellow_tea_leaf, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.yellow_tea_zisha_kettle)));
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.white_tea_leaf, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.white_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.oolong_tea_bag, 8)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.oolong_tea_zisha_kettle)));
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.oolong_tea_leaf, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.oolong_tea_zisha_kettle)));
        ...
        managerTeaTable.add(new TeaTableRecipe(NonNullListHelper.createNonNullList(new ItemStack(ItemRegister.puer_tea_leaf, 64)), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.empty_zisha_kettle), NonNullListHelper.createNonNullList(ItemStack.EMPTY), new ItemStack(BlockRegister.puer_tea_zisha_kettle)));
    }
