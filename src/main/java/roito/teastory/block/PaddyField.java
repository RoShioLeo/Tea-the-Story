...
public class PaddyField extends Block
{
	...
	{
		if (playerIn.getHeldItem(hand) != null && playerIn.getHeldItem(hand).getItem() == Items.BUCKET)
		{
			worldIn.setBlockState(pos, BlockLoader.field.getDefaultState());
	...
	{
		return new BlockStateContainer(this, new IProperty[] {NORTH, EAST, WEST, SOUTH, LEVEL});
	}
}
