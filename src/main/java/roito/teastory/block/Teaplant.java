...
public class Teaplant extends BlockBush implements IGrowable
{
		...
		if (!worldIn.isRemote)
		{
			switch(this.getMetaFromState(state))
			{
				case 8:
					...
					worldIn.spawnEntityInWorld(new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, new ItemStack(this.getCrop(), playerIn.getRNG().nextInt(4) + 1)));
					worldIn.spawnEntityInWorld(new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, new ItemStack(ItemLoader.broken_tea, playerIn.getRNG().nextInt(4) + 1)));
					return true;
				case 9:
					playerIn.addStat(AchievementLoader.teaPick);
					worldIn.setBlockState(pos, this.getStateFromMeta(10));
				...
				case 14:
					...
					worldIn.spawnEntityInWorld(new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, new ItemStack(this.getSeed(), playerIn.getRNG().nextInt(4) + 1)));
					return true;
				case 15:
					worldIn.setBlockState(pos, this.getStateFromMeta(7));
					worldIn.spawnEntityInWorld(new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, new ItemStack(this.getSeed(), playerIn.getRNG().nextInt(4) + 1)));
	...
	public java.util.List<ItemStack> getDrops(net.minecraft.world.IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
	{
		...
		if (age >= 4 && age <= 7)
		{
			ret.add(new ItemStack(ItemLoader.broken_tea, 4));
		}
		if (age >= 8 && age <= 13)
		{
