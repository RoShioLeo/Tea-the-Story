...
public class GuiContainerTeapan extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		this.fontRendererObj.drawString(time, (this.xSize - this.fontRendererObj.getStringWidth(time)) / 2, 70, 0x404040);
		if (this.inventory.isRaining())
		{
			String rain = I18n.translateToLocal("teastory.container.rain");
			this.fontRendererObj.drawString(rain, (this.xSize - this.fontRendererObj.getStringWidth(rain)) / 2, 53, 0x404040);
		}
		else if (!this.inventory.enoughLight())
		{
			String light = I18n.translateToLocal("teastory.container.light");
			this.fontRendererObj.drawString(light, (this.xSize - this.fontRendererObj.getStringWidth(light)) / 2, 53, 0x404040);
		}
	}
