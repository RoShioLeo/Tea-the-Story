...
public class CategoryTeaStoveSteam implements IRecipeCategory<IRecipeWrapper>
{
	...
	public CategoryTeaStoveSteam(IGuiHelper helper)
	{
	...
	{
		return I18n.format("jei.teastory.category.teastove.steam");
	}
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper)
	{
		...
		items.set(0, ((RecipeTeaStoveSteam) recipeWrapper).getInputs());
		items.init(1, false, 84, 21);
		items.set(1, ((RecipeTeaStoveSteam) recipeWrapper).getOutputs());
	}
