...
public class JEICompatRegister implements IModPlugin
{
    ...
    public void registerCategories(IRecipeCategoryRegistration registry)
    {
        registry.addRecipeCategories(
                new CategoryTeaStoveSteam(registry.getJeiHelpers().getGuiHelper()),
                new CategoryTeaStoveBake(registry.getJeiHelpers().getGuiHelper()),
                new CategoryTeaTable(registry.getJeiHelpers().getGuiHelper()),
                new CategoryDryingPan(registry.getJeiHelpers().getGuiHelper()),
                new CategoryTeapanDrying(registry.getJeiHelpers().getGuiHelper()),
                new CategoryTeapanFermentation(registry.getJeiHelpers().getGuiHelper()),
                new CategoryTeapanInRain(registry.getJeiHelpers().getGuiHelper()),
    ...
    public void register(IModRegistry registry)
    {
        ...
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperTeaStoveSteam(), "teastory.teastove.steam");
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperTeaStoveBake(), "teastory.teastove.bake");
        ...
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperTeapanDrying(), "teastory.teapan.drying");
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperTeapanFermentation(), "teastory.teapan.fermentation");
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperTeapanInRain(), "teastory.teapan.in_rain");
        registry.handleRecipes(ITeaMakingRecipe.class, new RecipeWrapperCookingPan(), "teastory.cookingpan");

        registry.addRecipeCatalyst(new ItemStack(BlockRegister.tea_stove), "teastory.teastove.steam", "teastory.teastove.bake");
        ...
        registry.addRecipeCatalyst(new ItemStack(BlockRegister.teapan), "teastory.teapan.drying", "teastory.teapan.fermentation", "teastory.teapan.in_rain");
        registry.addRecipeCatalyst(new ItemStack(BlockRegister.tea_drying_pan), "teastory.cookingpan");

        registry.addRecipes(RecipeTeaStoveSteam.getWrappedRecipeList(), "teastory.teastove.steam");
        registry.addRecipes(RecipeTeaStoveBake.getWrappedRecipeList(), "teastory.teastove.bake");
        ...
        registry.addRecipes(RecipeTeapanDrying.getWrappedRecipeList(), "teastory.teapan.drying");
        registry.addRecipes(RecipeTeapanFermentation.getWrappedRecipeList(), "teastory.teapan.fermentation");
        registry.addRecipes(RecipeTeapanInRain.getWrappedRecipeList(), "teastory.teapan.in_rain");
        registry.addRecipes(RecipeCookingPan.getWrappedRecipeList(), "teastory.cookingpan");

        registry.addRecipeClickArea(GuiContainerTeaStove.class, 78, 38, 24, 17, "teastory.teastove.steam", "teastory.teastove.bake");
        registry.addRecipeClickArea(GuiContainerTeaTable.class, 85, 33, 24, 17, "teastory.teatable");
        registry.addRecipeClickArea(GuiContainerTeapan.class, 33, 62, 110, 6, "teastory.teapan.drying", "teastory.teapan.fermentation", "teastory.teapan.in_rain");
    }
