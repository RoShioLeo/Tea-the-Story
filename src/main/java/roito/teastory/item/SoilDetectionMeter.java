...
public class SoilDetectionMeter extends TSItem
{
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if (worldIn.isRemote) 
		{
			...
			playerIn.sendMessage(new TextComponentTranslation("teastory.message.soil_detection_meter.fermentation", fermentationRateLevel1, fermentationRate1, fermentationRateLevel2, fermentationRate2));
			...
			playerIn.sendMessage(new TextComponentTranslation("teastory.message.soil_detection_meter.drying", dryingRateLevel1, dryingRate1, dryingRateLevel2, dryingRate2));
